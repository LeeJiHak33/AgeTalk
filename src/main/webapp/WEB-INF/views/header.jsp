	...
	<header style="position: absolute; z-index: 1">
		...
		<div class="menu_wrap">
			<ul class="menu_list" style="margin-bottom: 0; padding-left: 0">
				...
				<li><a class="popup"
					style="text-decoration: none; cursor: pointer">채팅하기
				</a></li>
				<li><a href="../user/notice" style="text-decoration: none">고객센터</a>
		...
		<div class="login_wrap" style="display: none;">
			<a href="login" style="text-decoration: none;">로그인
				&nbsp; | &nbsp; 회원가입</a>
		...
		<div class="login_wrap">
			<a data-bs-toggle="modal" data-bs-target="#MyModal"
				style="font-size: 15px; color: #ffff; cursor: pointer;"> 마이페이지 </a>
		</div>
		<!-- Modal -->
						...
						<div class="modal-header" style="display: block">
							...
							<div class="info">
								...
								<div style="display: flex; justify-content: flex-start">
									...
									<!--설문 완료시-->
									<a href="../user/diagnosis"><button type="button"
											class="modal_diagnosis">검사</button></a>
									<!-- 설문 미완료시 -->
		...
		<div class="modal fade" id="updateModal" tabindex="-1"
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content" style="top: 50px;">
					<div class="modal-head">
						<div class="modal-header">
							<p class="modal-title text-dark" id="ModalLabel">정보 수정</p>
							<button type="button" class="btn-close" data-bs-dismiss="modal"
								aria-label="Close"></button>
						</div>
						<div class="modal-header">
						...
						<div class="modal-header" style="display: block">
							...
							<div class="info">
								...
								<div class="input-group mb-4">
									<span class="text-dark input-group-text">휴대폰</span> <input
										name="phone" type="text" value="${item.phone}"
										class="form-control">
								</div>
								<div class="input-group mb-4" style="padding-bottom: 10px;">
									<span class="text-dark input-group-text">아이디</span> <input
										name="id" type="text" value="${item.id}" class="form-control">
								</div>

								<div style="display: flex; justify-content: flex-start">
									<p class="text-dark" style="font-size: 18px;">설문조사여부 : {완료
										& 미완료}</p>
									<!--설문 완료시-->
									<a href="../user/diagnosis"><button type="button"
											class="modal_diagnosis">검사</button></a>
