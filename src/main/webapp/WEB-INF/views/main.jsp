...
<html>
  ...
  <body>
    <div class="main">
      ...
      <div class="bg_img">
        ...
        <p class="main_subtitle">
          문화적 다양성을 누리고 새로운 인연을 만나는 곳,<br />AgeTalk에서
          시작해보세요!
        </p>
        <!-- 스크롤 다운 애니메이션 -->
    ...
    <div class="main_sub" data-aos="fade-down" data-aos-duration="1000">
      <h2>채팅</h2>
      <p class="sub">
        AgeTalk는 서로의 마음을 나누고 치유할 수 있는 공간을 제공합니다.<br />1:1
        채팅을 통하여 소중한 시간을 나눠보세요.
      </p>
    ...
    <div class="sub_grid">
      <div class="item" data-aos="zoom-in">
        ...
        <p class="sub_content">
          AgeTalk는 청년과의 채팅을 통해 노년시기의 우울감을<br />개선하고
          사람과 사람, 사람과 기술간의 커뮤니케이션을<br />
          더 가깝고 더 안전하게 돕습니다. 청년과의 소통을 통해<br />노년 시기에
          사회적 연결성을 증진하고, 우울감을 개선<br />하는 것에 큰 도움을
          줍니다.
        </p>
      </div>
      <div class="item" data-aos="zoom-in" data-aos-delay="300">
        ...
        <p class="sub_content">
          청년들은 어르신들의 지식과 경험으로부터 많은 것을<br />배울 수 있으며,
          어르신들도 청년들로부터 새로운 시각과<br />지식을 얻을 수 있습니다.
          이러한 세대간 교류와 상호<br />
          이해는 우리 사회에 긍정적인 영향을 미칠 것 입니다.
        </p>
      </div>
      <div class="item" data-aos="zoom-in" data-aos-delay="500">
        ...
        <p class="sub_content">
          문제를 해결하거나 새로운 아이디어를 생각해내는<br />과정에서 다양한
          의견과 관점이 필요합니다. 이는<br />우울감이라는 문제를 해결하는데
          도움을 줄 수 있으며<br />더 나아가 서로를 이해하고 갈등을 예방할 수
          있습니다.
        </p>
      </div>
      <script>
