			...
			<div class="su_wrap">
				...
				<form method="post" name="signup_form"  enctype="multipart/form-data">
					<div class="lg_wrap">
						<div class="id_wrap">
							...
							<div class="id_subwrap">
								...
								<button type="button" class="login_check" onclick="checkId(true)">중복확인</button>
							</div>
						</div>
						...
						<div class="pw_wrap">
							<label>비밀번호 확인</label> <input type="password" name="passwd_chk"
								placeholder="비밀번호 확인을 위하여 위와 동일하게 입력해주세요.">
						</div>
						<div class="pw_wrap">
					...
					<div class="signup_btn">
						<button type="button" style="color: white" onclick="signup()">회원가입</button>
					</div>
				</form>
